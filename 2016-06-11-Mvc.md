...
So why is important to understand MVC? It is important to understand MVC because most frameworks use this architecture when working 
with them.Rails,Django,Flask ,Laravel,CodeIgniter and CakePHP all use MVC.MVC helps us create a nice structure for our applications 
because we separate different codes for different sections and therefore everything has its place.
